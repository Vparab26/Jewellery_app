...
import com.example.kisan_suvidha.activities.DetailedActivity;
...
public class ViewAllAdapter extends RecyclerView.Adapter<ViewAllAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.view_item_img);
            name = itemView.findViewById(R.id.view_item_name);
            description = itemView.findViewById(R.id.view_item_desc);
