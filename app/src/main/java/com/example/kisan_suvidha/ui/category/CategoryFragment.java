package com.example.kisan_suvidha.ui.category;
...
import com.example.kisan_suvidha.adapters.NavCategoryAdapters;
...
public class CategoryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        navCategoryAdapters = new NavCategoryAdapters(getActivity(),categoryModelList);
        recyclerView.setAdapter(navCategoryAdapters);
